...
<div class="container">
        ...
        <form:form  name="form" method="POST" action="login" ModelAttribute="user" >
      <!--       <form method = "po" action="#"> -->
                <div class="page slide-page">
                    ...
                    <div class="field">
                        <div class="label">
                            Name</div>
                        <input type="text" path="userName" id = "userName" required>
                    </div>
                    <div class="field">
                        <div class="label" >
                            DoB</div>
...
<body>
	...
	<form:form name="form" method="POST" action="save"
		ModelAttribute="user">
		<table>
			...
			<tr>
				...
				<td>
					<div class="correct" id="passcorrect"></div>
				</td> -->
			</tr>
